...
from meanShiftTracker import MeanShiftTracker,MSParams
from correlation_tracker import CorrelationTracker



# set the path to directory where you have the sequences
dataset_path = '/home/erik/Documents/Projects/Faculty/advanced_methods_in_CV/project2/untitled/data' # TODO: set to the dataet path on your disk
